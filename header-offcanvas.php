...
<html <?php language_attributes(); ?>>
	...
	<body <?php body_class(); ?>>
		...
		<header id="masthead" class="site-header">
			...
			<!-- Toggler -->
            <button class="navbar-toggler" type="button" data-toggle="offcanvas" data-target="#bootscore-navbar-collapse" aria-controls="#bootscore-navbar-collapse" aria-expanded="false" aria-label="Toggle navigation">
